...
public class SsimCalculator 
{
    ...
    public SsimCalculator(byte []img) throws IOException
    {
        this.refImage = getBufferedImageForBytes(img);
    }
    ...
    private WindowManager getWindowManager(BufferedImage img) throws SsimException
    {
        final BufferedImage compImg = img;
    ...
    public double compareTo(BufferedImage compBytes) throws SsimException, IOException
    {
        //final byte[] compBytes = loadFile(comp);
        final WindowManager manager = getWindowManager(compBytes);
